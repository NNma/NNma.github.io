...
//			console.log(lis_1[0]);
	...
	function Mask2_4(){
		...
		mask2_4.eq(0).animate({height : '56'},500,function(){
			onOff = false;
			mask2_4.eq(0).animate({width : '16'},300,function(){
				mask2_4.eq(0).animate({height : '0'},150,function(){
	...
	function Mask2_3(){
		...
		mask2_3.eq(0).animate({height : '48'},150,function(){
			onOff = false;
			mask2_3.eq(0).animate({width: '16'},500,function(){
				mask2_3.eq(0).animate({height : '0'},150,function(){
	...
	function Mask2_2(){
		...
		mask2_2.eq(0).animate({height : '174'},400,function(){
			onOff = false;
			mask2_2.eq(0).animate({width: '14'},300,function(){
				mask2_2.eq(0).animate({height : '0'},300,function(){
					mask2_2.eq(1).animate({width : '0'},500,function(){
	...
	function Mask2_1(){
		...
		mask_2.eq(0).stop().animate({height : '0'},800,function(){
			onOff = false;
			mask_2.eq(1).animate({width : '0'},400,function(){
				mask_2.eq(2).animate({height : '0'},300),
				mask_2.eq(3).animate({height : '0'},300,function(){
	...
	function recover2_4(fn){
		var mask2_4 = $('#line2_4').find('.mask');
		$('#line_p4').animate({opacity:'0',top: '30'},200,function(){	
			onOff = false,
			mask2_4.eq(1).animate({width: '170'},400,function(){
				mask2_4.eq(0).animate({height : '56'},150,function(){
					mask2_4.eq(0).animate({width : '126'},300,function(){
						mask2_4.eq(0).animate({height : '213'},500,function(){
							$('#line2_4').css({display : 'none'});
							onOff = true
							fn && fn();
						})
	...
	function recover2_3(fn){
		...
		$('#line_p3').animate({opacity:'0',top: '110'},200,function(){
			onOff = false,
			mask2_3.eq(0).animate({height : '48'},150,function(){
				mask2_3.eq(0).animate({width: '224'},500,function(){
					mask2_3.eq(0).animate({height : '80'},150,function(){
						$('#line2_3').css({display : 'none'});
						onOff = true
						fn && fn();
					});
	...
	function recover2_2(fn){
		...
		$('#line_p2').animate({opacity:'0',top: '180'},200,function(){
			onOff = false,
			mask2_2.eq(1).animate({width : '155'},500,function(){
				mask2_2.eq(0).animate({height : '174'},300,function(){
					mask2_2.eq(0).animate({width: '125'},300,function(){
						mask2_2.eq(0).animate({height : '247'},400,function(){
							$('#line2_2').css({display : 'none'});
							onOff = true
							fn && fn();
						})
	...
	function recover2_1(fn){
		var mask_2 = $('#line_2').find('.mask');
		$('#line_p1').animate({opacity:'0',left: '300'},200,function(){
			onOff = false,
			$('.line_p').css({display : 'none'}),
			mask_2.eq(4).animate({width : '61'},150,function(){
				mask_2.eq(3).animate({height : '114'},300),
				mask_2.eq(2).animate({height : '114'},300,function(){
					mask_2.eq(1).animate({width: '155'},400,function(){
						mask_2.eq(0).stop().animate({height: '279'},800,function(){
	...
	function Mask4_1(){
		...
		mask4_1.eq(0).stop().animate({height : '35'},400,function(){
			mask4_1.eq(0).animate({width : '10'},500,function(){
				mask4_1.eq(0).animate({height : '0'},100,function(){
	...
	function Mask4_2(){
		...
		mask4_2.eq(0).animate({height : '28'},400,function(){
			mask4_2.eq(0).animate({width : '10'},1000,function(){
	...
	function Mask4_3(){
		...
		mask4_3.eq(0).animate({height : '36'},400,function(){
			$('#line4_3').animate({opacity: 0},300,function(){
				mask4_3.eq(0).animate({width : '10'},1000,function(){
					mask4_3.eq(0).animate({height : '0'},200)
				});
				mask4_3.eq(1).animate({height : '10'},1000,function(){
					mask4_3.eq(1).animate({width : '0'},300,function(){
	...
	function Mask4_4(){
		...
		mask4_4.eq(0).animate({height : '28'},300,function(){
			mask4_4.eq(0).animate({width : '10'},1000,function(){
	...
	function recover4_4(fn){
		...
		mask4_4.eq(0).animate({height : '28'},200,function(){
			mask4_4.eq(0).animate({width : '599'},1000,function(){
				mask4_4.eq(0).animate({height : '85'},400,function(){
					$('#line4_4').css({display : 'none'});
					fn && fn();
				})
			})
	...
	function recover4_3(fn){
		var mask4_3 = $('#line4_3').find('.mask');
		mask4_3.eq(1).animate({width : '80'},300,function(){
			mask4_3.eq(1).animate({height : '360'},1000)
		})
		mask4_3.eq(0).animate({height : '36'},200,function(){
			mask4_3.eq(0).animate({width : '582'},1000,function(){
				mask4_3.eq(0).animate({height : '62'},200,function(){
					$('#line4_3').css({display : 'none'});
					fn && fn();
				})
			})
	...
	function recover4_2(fn){
		...
		mask4_2.eq(0).animate({height : '28'},200,function(){
			mask4_2.eq(0).animate({width : '551'},1000,function(){
				mask4_2.eq(0).animate({height : '108'},400,function(){
					$('#line4_2').css({display : 'none'});
					fn && fn();
				})
			})
	...
	function recover4_1(fn){
		var mask4_1 = $('#line4_1').find('.mask');
		$('.line4_div').animate({opacity: '0'},200,function(){
			mask4_1.eq(0).animate({height : '35'},100,function(){
				mask4_1.eq(0).animate({width : '205'},500,function(){
					mask4_1.eq(0).animate({height : '95'},400,function(){
...
//			console.log(M)
	...
	function main4_sc(){
		...
		var str = '';
		for(var i = 0; i < 27; i++){
			str += '<li><img src="img/cloud.png"/>'+i+'</li>';
		}
		Ul[0].innerHTML = str;
	}
